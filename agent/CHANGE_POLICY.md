...
| Action                        | Scope                                                                                                                              |
| ----------------------------- | ---------------------------------------------------------------------------------------------------------------------------------- |
| Add new files                 | Under `agent/` only — no approval gate                                                                                             |
...
| Update AI-agent harness files | `AGENTS.md`, `CLAUDE.md`, `GEMINI.md`, `.github/copilot-instructions.md`, `.github/prompts/*.md` — these are agent docs, not CI/CD |
| Fix linting/formatting        | `agent/` docs only — no spec required; application files require at minimum a LOW spec                                             |
...
| Modify `.github/workflows/` or `.github/dependabot.yml`                                  | CI/CD & dependency automation — human-only |
| Modify GitHub issue/PR templates (`.github/ISSUE_TEMPLATE/`, `PULL_REQUEST_TEMPLATE.md`) | Repo process — human-only                  |
