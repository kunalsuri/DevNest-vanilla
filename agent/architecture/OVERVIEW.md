...
| `JWT_ACCESS_SECRET`       | _(dev default)_             | Signs access tokens (min 32 chars; required in production)    |
| `JWT_REFRESH_SECRET`      | _(dev default)_             | Signs refresh tokens (min 32 chars; required in production)   |
| `SESSION_SECRET`          | _(dev default)_             | Session signing secret (min 32 chars; required in production) |
