...
machine-readable file: **[`ai-meta/INDEX.yaml`](INDEX.yaml)**. They are no longer duplicated here.
...
Apply these on top of the per-level gating in [`AGENT_GUIDE.md`](AGENT_GUIDE.md#3-safety-level-gating):
