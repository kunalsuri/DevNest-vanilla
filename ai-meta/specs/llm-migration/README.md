...
A YAML here is a *contract sketch*, not an approved change. Before writing code, create a
standard spec at `ai-meta/specs/<feature>/spec.md` (see [`../TEMPLATE.md`](../TEMPLATE.md)),
